...
#define CONFIG_EXAMPLE_ETH_SPI_SCLK_GPIO 15
#define CONFIG_EXAMPLE_ETH_SPI_MOSI_GPIO 13
#define CONFIG_EXAMPLE_ETH_SPI_MISO_GPIO 14
#define CONFIG_EXAMPLE_ETH_SPI_CLOCK_MHZ 16
#define CONFIG_EXAMPLE_ETH_SPI_CS0_GPIO 16
#define CONFIG_EXAMPLE_ETH_SPI_INT0_GPIO 12
